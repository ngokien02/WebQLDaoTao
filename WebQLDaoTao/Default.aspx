...
<asp:Content ID="Content2" ContentPlaceHolderID="Main" runat="server">
    ...
    <div>
        ...
        <div class="container" style="margin-top: 50px; border: 2px solid blue; padding: 30px; border-radius: 20px;
        width: 80%; font-size: large; background-color: white;">
            <div class="form-group">
                <label for="username">Tên đăng nhập</label>
                <asp:TextBox runat="server" type="text" class="form-control" ID="txtUsername" 
                    placeholder="Tên đăng nhập..." Height="50px"></asp:TextBox>
            </div>
            <div class="form-group">
                <label for="password">Mật khẩu</label>
                <asp:TextBox runat="server" type="password" class="form-control" ID="txtPassword" 
                    placeholder="Mật khẩu" Height="50px"></asp:TextBox>
            </div>
