...
<asp:Content ID="Content2" ContentPlaceHolderID="Main" runat="server">
    ...
    <asp:GridView ID="gvKetQua" runat="server"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Chọn để xóa" ItemStyle-HorizontalAlign="Center">
                <ItemTemplate>
                ...
                <FooterTemplate>
                    ...
                    <asp:CheckBox ID="cbxChonAll" runat="server" CssClass="btn btn-info" Text="Chọn tất cả" 
                        OnCheckedChanged="cbxChonAll_CheckedChanged" AutoPostBack="true" Height="34px" />
                </FooterTemplate>
            </asp:TemplateField>
        </Columns>
